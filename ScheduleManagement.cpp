...
/**
 * Verifica se é possível fazer a mudanção ou adição de turma com base limite de diferença alunos por turma de de uma UC.
 * Complexidade= O(n*log(n)), n -> tamanho da lista sort.
